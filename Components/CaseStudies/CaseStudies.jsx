    ...
    <section className="relative min-h-screen">
      ...
      <div className="relative z-10 px-4 md:px-8 pb-20">
        <Swiper
          ...
          pagination={{
            clickable: true,
            bulletClass: "swiper-pagination-bullet case-study-bullet",
            bulletActiveClass: "swiper-pagination-bullet-active case-study-bullet-active",
          }}
          navigation={{
        ...
        <div className="flex justify-center items-center gap-4 mt-8">
          <button className="case-study-prev w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-[#E436A2] hover:bg-[#E436A2] hover:text-white transition-all duration-300">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
          </button>
          <button className="case-study-next w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-[#E436A2] hover:bg-[#E436A2] hover:text-white transition-all duration-300">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
